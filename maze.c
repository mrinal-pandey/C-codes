 ...
 * Program to find the path in a given maze of 0s and 1s using backtracking [VTU 3rd sem DS course]
 * 0 signifies the step which can be taken
 * 1 signifies the step which can not be taken
 * Input is the maze, ouput is the path to be taken
 * */
